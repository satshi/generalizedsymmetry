...
\begin{align}
  Z_{\Tcal/G,\text{new}}=\sqrt{N}^{\chi}Z_{\Tcal/G, \text{いままでの}}.
\end{align}
...
\subsection{半空間ゲージ化}
ここから選んだ$D$に対して、具体的な半空間ゲージ化の手続きを説明します。基本的には、
